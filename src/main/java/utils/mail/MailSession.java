...
/**
 * @Description 邮件会话对象 @Author Skye @Date 2022/11/25 20:16
 */
@AllArgsConstructor
@Getter
public class MailSession {
    ...
    public static class MailSessionBuilder {
        ...
        // 指导的协议
        private String protocol = MailSession.SMTP_PROTOCOL;
        // 对应的端口
        ...
        public MailSession build() {
            ...
            // 如果是STMP协议
            if (SMTP_PROTOCOL.equals(protocol)) {
